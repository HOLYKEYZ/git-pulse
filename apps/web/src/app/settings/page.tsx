    ...
    return (
        <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 animate-fade-in">
            ...
            {activeTab === "account" && (
                <div className="space-y-6">
                    <div className="rounded-lg border border-git-border bg-git-card p-5">
                        <h2 className="text-base font-semibold text-git-text mb-1">connected accounts</h2>
                        <p className="text-xs text-git-muted mb-4">link your GitHub account to sync activity and repos.</p>
