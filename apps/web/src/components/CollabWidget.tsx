    ...
    return (
        <div className="border border-git-border rounded-lg p-4 bg-git-card">
            <h3 className="text-sm font-semibold text-git-text mb-3 flex items-center gap-2">
                <svg height="16" viewBox="0 0 16 16" width="16" className="fill-git-blue">
                ...
                {matches.map((match) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col min-w-0 flex-1">
                            <span className="text-sm text-git-text font-medium group-hover:text-git-blue transition-colors truncate">
                                @{match.username}
                            </span>
