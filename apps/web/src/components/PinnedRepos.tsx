                ...
                {repos.map((repo) => (
                    ...
                    >
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" className="fill-git-muted shrink-0 cursor-grab hover:fill-git-text transition-colors">
                                <path d="M3 4.5h10V3H3Zm0 5h10V8H3Zm0 5h10v-1.5H3Z"></path>
                            </svg>
                        </div>
