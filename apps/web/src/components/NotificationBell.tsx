    ...
    return (
        ...
        >
            <div className="relative">
                ...
                {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] rounded-full bg-git-blue text-white text-[11px] font-bold px-1 border-2 border-git-bg">
