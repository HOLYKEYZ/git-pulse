...
className="flex items-center gap-1.5 px-3 py-1.5 border border-git-border rounded-md text-sm font-medium text-sponsor hover:bg-sponsor/10 hover:border-sponsor/30 transition-all"
                            >
                              <svg viewBox="0 0 16 16" width="16" height="16" className="fill-sponsor">
