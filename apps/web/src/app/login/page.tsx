                ...
                <div className="mt-8 space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="bg-git-card px-2 text-git-muted">or use email</span>
                        </div>
                    </div>
                    ...
                    <p className="text-center text-sm text-git-muted">
                        No account? <Link href="/signup" className="font-semibold text-git-green hover:underline">Sign up manually</Link>
                    </p>
                </div>
            </div>
        </div>
